...
public class CoronaVirusData {
    ...
    private static String VirusDataURl ="https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_confirmed_US.csv";
    ...
    public void getCoronaData() throws IOException, InterruptedException {
        ...
        for (CSVRecord record : records) {
            ...
            locationStats.setLatestDate(latestCases);
            locationStats.setPrevDay(latestCases - prevCases);
